...
craftingTable.addShaped("bm_token", <item:the_vault:bm_token> * 8, [
        [<item:vaultadditions:power_crystal>, <item:vaultadditions:power_crystal>, <item:vaultadditions:power_crystal>],
        [<item:vaultadditions:power_crystal>, <item:the_vault:soul_vortex>, <item:vaultadditions:power_crystal>],
        [<item:vaultadditions:power_crystal>, <item:vaultadditions:power_crystal>, <item:vaultadditions:power_crystal>],
    ]);
